...
const LinksWrapper = styled.div`
  ...
  ${(p) => (p.first ? `margin-left: 164px;` : "")}
  ${(p) => (p.last ? `margin-right: 16px;` : "")}

  @media ${QUERIES.tabletAndSmaller} {
    ${(p) => (p.first ? `margin-left: 24px;` : "")}
  }
  ...
  return (
    <MyWrapper>
      <Container>
        <LogoContainer>
          <Image
            src={"/frontendmentor_14/logo_footer.svg"}
            alt={"footer logo image"}
          />
        </LogoContainer>

        <LinksWrapper first={true}>
